...
const Channels: React.FC = () => {
  const socialChannels = [
    ...
    {
      name: 'Twitter',
      description: 'Follow for tips and news',
      href: '#',
      icon: (
        <svg width="32" height="32" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      name: 'Instagram',
      description: 'See student achievements',
      href: '#',
      icon: (
        <svg width="32" height="32" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    <section className="landing-section" id="channels">
      <div className="landing-container">
        <div className="text-center">
          <h2 className="landing-title">Connect With Us</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {socialChannels.map((channel) => (
            ...
            >
              ...
              <p className="text-sm text-gray text-center">{channel.description}</p>
            </a>
          ))}
        </div>
      </div>
